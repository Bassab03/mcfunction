const things = require("./id/path.json");
const commands = require("./commands.json");
const blocks = Object.keys(things.registries["minecraft:block"][0]);
...
const items = Object.keys(things.registries["minecraft:item"][0]);
const slots = require("./id/slot.json");
const entities = Object.keys(things.registries["minecraft:entity"][0]);
