...
class ReloadCommand12 extends BaseCommand {
  ...
  handleSuggestions(tokens) {
    ...
    case 1: {
      return [new CommandNameOutput("reload", "Reloads world resources and datapacks. Must set <code>function-permission-level=4</code> or higher. Unsure if this actually works in datapacks.")];
    }
    case 2: {
      return [
        new SelectorOutput
