...
const CoordinateOutput = require("../class/output/CoordinateOutput");
const EnumOutput = require("../class/output/EnumOutput");
const ItemOutput = require("../class/output/ItemOutput");
const LootTableOutput = require("../class/output/LootTableOutput");
const NumberOutput = require("../class/output/NumberOutput");
const SlotOutput = require("../class/output/SlotOutput");
