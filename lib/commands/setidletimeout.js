...
class SetIdleTimeoutCommand extends BaseCommand {
  ...
  handleSuggestions(tokens) {
    ...
    case 1: {
      return [new CommandNameOutput("setidletimeout", "Sets the idle timeout before players are kicked. Multiplayer only; Must set <code>function-permission-level=3</code> or higher.")];
    }
    case 2: {
