const BaseCommand = require("../class-old/BaseCommand"),
  CommandNameOutput = require("../class-old/output/CommandNameOutput"),
  SelectorOutput = require("../class-old/output/SelectorOutput"),
  CoordinateOutput = require("../class-old/output/CoordinateOutput"),
  StringOutput = require("../class-old/output/StringOutput"),
  BlockOutput = require("../class-old/output/BlockOutput"),
  EnumOutput = require("../class-old/output/EnumOutput"),
  NumberOutput = require("../class-old/output/NumberOutput"),
  DimensionOutput = require("../class-old/output/DimensionOutput");
