...
const AdvancementOption = require("./AdvancementOption");
const AttributeOption = require("./AttributeOption");
const BiomeOption = require("./BiomeOption");
const BlockOption = require("./BlockOption");
const BooleanOption = require("./BooleanOption");
const CoordinateOption = require("./CoordinateOption");
const DimensionOption = require("./DimensionOption");
const EffectOption = require("./EffectOption");
const EnchantmentOption = require("./EnchantmentOption");
const EntityOption = require("./EntityOption");
const GameruleOption = require("./GameruleOption");
const LootTableOption = require("./LootTableOption");
const ObjectiveOption = require("./ObjectiveOption");
const ParticleOption = require("./ParticleOption");
const RecipeOption = require("./RecipeOption");
const ScoreboardDisplayOption = require("./ScoreboardDisplayOption");
const SlotOption = require("./SlotOption");
const SoundOption = require("./SoundOption");
const StructureOption = require("./StructureOption");
...
class Section extends BaseOption {
   ...
   */
  addItemOption(label, entityCallback) {
   ...
   */
  addSoundOption(label, lootTableCallback) {
   ...
   */
  addSoundOption(label, structureCallback) {
